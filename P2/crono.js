...
const soundBomba = new Audio('bomba.mp3');
...
class Crono {
    ...
    tic() {
        ...
        //-- Verificar si han pasado 5 segundos sin adivinar la clave
        if (this.min === 0 && this.seg === 5 && this.cent === 0) {
            clearInterval(this.timer);
            this.timer = null;
            soundBomba.play();
            alert("¡La bomba ha explotado!¡Has perdido!");
        }
    }
